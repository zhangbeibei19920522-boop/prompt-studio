...
describe("knowledge automation model", () => {
  ...
  it("normalizes legacy completed draft tasks back to risk review when draft versions still have gated content", () => {
    const task = {
      id: "task-legacy",
      projectId: "project-1",
      knowledgeBaseId: "kb-1",
      knowledgeVersionId: "kv-legacy",
      knowledgeIndexVersionId: null,
      name: "旧任务",
      taskType: "full" as const,
    ...
    const effective = resolveEffectiveTaskState(task, [
      {
        id: "kv-legacy",
        knowledgeBaseId: "kb-1",
        taskId: "task-legacy",
